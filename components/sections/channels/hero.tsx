    ...
    <section className="bg-[#f3f2f0] px-5 pb-5 pt-[118px] sm:px-7 sm:pb-6 sm:pt-[122px] lg:px-5 lg:pb-5 lg:pt-[120px]">
      <div className="mx-auto max-w-full border border-[#dad8d3] bg-[#f3f2f0] px-4 pb-4 pt-4 sm:px-5 sm:pb-5 sm:pt-5 lg:px-5 lg:pb-5 lg:pt-5">
        <div className="relative aspect-[2/1] w-full overflow-hidden bg-black">
          ...
          <div className="absolute inset-x-0 bottom-0 flex flex-col gap-4 px-4 pb-4 text-white sm:flex-row sm:items-end sm:justify-between sm:px-10 sm:pb-7 lg:px-8 lg:pb-6">
            <h1 className="max-w-[1010px] text-[1rem] font-black uppercase leading-[1.02] tracking-[-0.04em] text-[#f4f1ea] sm:text-[2rem] lg:text-[2.35rem]">
